...
/*!*****************************!*\
  !*** ./src/non_updating.js ***!
  \*****************************/
var NotUpdatingIssues = [];
var daysNotUpdating = 4;
var SiteData = [{
  "ID": 604261,
  "TL": "Godfred Ardeyfio"
}, {
...
function showNotUpdating() {
  ...
  tableToJSON().forEach(function (_ref) {
    var SiteID = _ref.SiteID,
        ...
        RowRef = _ref.RowRef;
    timeDiff = (new Date().getTime() - new Date(TimeStamp).getTime()) / (1000 * 60 * 60);

    if (timeDiff > 1 && timeDiff < 145) {
      var _site = SiteData.find(function (site) {
  ...
  console.dir(NotUpdatingIssues); // return false; 

  if (NotUpdatingIssues.length > 0) {
    var sortedIssues = NotUpdatingIssues.sort(function (a, b) {
...
function displayIssuesOverlay(issues) {
  createOverlay();
  var tbodyRef = document.querySelector(".body tbody");
  dragElement(document.querySelector(".info-overlay"));
  var tpl = "";

  if (issues < 30) {
    issues.forEach(function (_ref2) {
...
function attachDownload() {
  var formatedCSV = NotUpdatingIssues.map(function (_ref4) {
  ...
  var keys = Object.keys(formatedCSV[0]);
  var CSV = [keys.join(","), formatedCSV.map(function (row) {
...
/******/ })()
;
//# sourceMappingURL=non_updating_mon.bundle.js.map